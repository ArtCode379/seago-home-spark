Generate and install the app icon for /tmp/seago-home-spark.
...
/tmp/seago-home-spark/app/src/main/res/drawable/icon.png
...
```text
professional 512 by 512 vector app icon, bold high-contrast lettering "SHS" combined with diamond, leaf, calendar accent, soft service badge integrated into the design, solid opaque colored rounded-square canvas using #1B3A5C, clearly rounded app-icon corners with transparent pixels outside the rounded canvas, perfectly centered composition, all shapes complete and uncut, clean flat vector illustration, sharp and fully legible typography, commercial app icon quality
...
After saving icon.png, validate it with `bash /home/codex-agent/codex-app-agent/validate-icon.sh /tmp/seago-home-spark/app/src/main/res/drawable/icon.png`.
