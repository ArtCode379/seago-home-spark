package seago.household.seagohomespark.ui.composable.approot
...
import seago.household.seagohomespark.ui.composable.navigation.AppNavHost
import seago.household.seagohomespark.ui.composable.navigation.NavRoute
...
private val navigationItems: List<BottomNavItem> = listOf(
    BottomNavItem(
        titleRes = R.string.kgugn_bottom_bar_nav_item_home_title,
        icon = Icons.Default.Home,
        route = NavRoute.Home,
    ),
    BottomNavItem(
        titleRes = R.string.kgugn_bottom_bar_nav_item_cart_title,
        icon = Icons.Default.ShoppingCart,
        route = NavRoute.Cart,
    ),
    BottomNavItem(
        titleRes = R.string.kgugn_bottom_bar_nav_item_orders_title,
        icon = Icons.Default.CalendarToday,
        route = NavRoute.Orders,
    ),
    BottomNavItem(
        titleRes = R.string.kgugn_bottom_bar_nav_item_settings_title,
